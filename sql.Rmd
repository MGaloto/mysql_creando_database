...
```{r, echo=FALSE, out.width="60%", fig.align='center'}
knitr::include_graphics("Imagenes/bdrelacional.png")
```
...
```{r, echo=FALSE, out.width="60%", fig.align='center'}
knitr::include_graphics("Imagenes/esttablas.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap='Uno a uno'}
knitr::include_graphics("Imagenes/unouno.png")
```



```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap='Uno a Muchos'}
knitr::include_graphics("Imagenes/unomuchos.png")
```



```{r, echo=FALSE, out.width="80%", fig.align='center', fig.cap='Muchos a Muchos'}
...
knitr::include_graphics("Imagenes/fun.png")
```
...
<b><span style = "color:purple">import</span></b> pymysql
<b><span style = "color:purple">import</span></b> pandas <b><span style = "color:purple">as</span></b> pd

connection = pymysql.connect(host= <b><span style = "color:green">'Poner el Host'</span></b>, 
                             user= <b><span style = "color:green">'Poner el User'</span></b>, 
                             password= <b><span style = "color:green">'Poner el Pass'</span></b>, 
...
query = <b><span style = "color:green">'SELECT * FROM vista_consulta_diagnostico'</span></b>
...
df.to_excel(<b><span style = "color:green">'df.xlsx'</span></b>, index=<b><span style = "color:orange">False</span></b>)

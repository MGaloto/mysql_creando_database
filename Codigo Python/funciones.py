...
# Query SQL para crear las Funciones:
    
    
sql_create_function_calcular_covid_diagnosticos = '''
                                                DELIMITER $$
...
sql_create_function_calcular_resultado = '''
                                        DELIMITER $$
...
query_calcular_covid_diagnosticos = '''
                                SELECT calcular_covid_diagnosticos('covid') as porcentaje_diagnostico;'''


query_calcular_calcular_resultados = '''
...
cursor.execute(sql_create_function_calcular_covid_diagnosticos)
cursor.execute(sql_create_function_calcular_resultado)
cursor.execute(query_calcular_covid_diagnosticos)
cursor.execute(query_calcular_calcular_resultados)
